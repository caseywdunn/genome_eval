...
agalma catalog insert --id "Globodera" --paths /gpfs/data/cdunn/sequences/public/animal_genomes/aa/Globodera_pallida_1_proteins.faa --species "Globodera pallida"
