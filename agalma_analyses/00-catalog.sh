...
agalma catalog insert --id "Canis" --paths /gpfs/data/cdunn/sequences/public/animal_genomes/aa/Canis_familiaris_31_proteins_all.faa --species "Canis familiaris"
...
agalma catalog insert --id "Tetranychus" --paths /gpfs/data/cdunn/sequences/public/animal_genomes/aa/Tetranychus_urticae_1_30_proteins_all.faa --species "Tetranychus urticae"
...
agalma catalog insert --id "Echinococcus" --paths /gpfs/data/cdunn/sequences/public/animal_genomes/aa/Echinococcus_multilocularis_3_proteins.faa --species "Echinococcus multilocularis"
